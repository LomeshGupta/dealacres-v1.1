...
const Navbar = () => {
  ...
  return (
    <div
      className={`navbar${isHomePage ? "" : "Page"}${
        scrolled ? " scrolled" : ""
      }`}>
          ...
          <div className="navbar-menu_container">
            <div className="navbar-menu_container-links">
              ...
              <div className="navbar-menu_container-links-sign">
                ...
                <button type="button" onClick={() => openSignupPopup("SignUp")}>
                  Sign Up
                </button>
              </div>
            </div>
      ...
      <div className="navbar-links">
        ...
        <div className="custom-select-container ">
          <select
            ...
            <option className="text-black bg-white" value="Gurugram">
              Gurugram
            </option>
            <option className="text-black bg-white" value="Delhi">
              Delhi
            </option>
      ...
      <Link href="/propertylisting">
        <div className="md:hidden bg-white p-1 font-semibold text-blue-600 text-xs rounded-lg">
          Post Property <span className=" text-green-700 ">Free</span>
        </div>
      </Link>
      {hoveredMenu && (
        <div
