    ...
    return (
        <div className='bg-[#c5dff8] p-4 md:p-8 '>
            ...
            <div className='flex justify-center'>
                ...
                <Link href="/allservice" className="px-2 py-0.5 md:px-4 md:py-2 bg-blue-500 text-white text-[0.73rem] md:text-base rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">View All</Link>
                </div>
